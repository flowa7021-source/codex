...
- [x] Стабильные настройки границ/зон с live-preview и persisted state.

## P1 — Тестирование и качество
- [x] E2E regression-pack (Playwright) для 20+ ключевых пользовательских сценариев.
- [x] OCR corpus benchmark (качество + скорость).
- [x] PDF conversion benchmark suite (структура/таблицы/картинки).
- [x] Crash telemetry dashboard + session health export.

## P2 — Расширения 2.0.x
- [x] Импорт обратно DOCX-правок (merge в workspace).
- [x] Плагины конвертации для сложных табличных шаблонов.
- [x] Дополнительные языковые профили OCR (28 языков).
