...
Текущий прогресс выполнения плана: **54%**.
...
## Этапы и прогресс
- [x] Phase 0 — Baseline и диагностика: **80%**
- [ ] Phase 1 — Стабильность ядра: **70%**
- [ ] Phase 2 — Производительность/UI responsiveness: **12%**
...
2. Расширить perf-baseline до p95 по OCR/search/render на реальных сценариях.
